...
const PrivacyPolicy = () => {
    return (
      ...
      <div className='header-section'>
        ...
        <section className='container about-body'>
            <div className='content content-privacy font-arial'>
            
            <h1>Privacy Policy for thenftslot.com</h1>
           <div>
  <p>At thenftslot, accessible from https://www.thenftslot.com, one of our main priorities is the
    privacy of our visitors. This Privacy Policy document contains types of information that is
    collected and recorded by thenftslot and how we use it.</p>
  <p>If you have additional questions or require more information about our Privacy Policy, do not
    hesitate to contact us.</p>
  <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
    with regards to the information that they shared and/or collect in thenftslot. This policy is not
  ...
  <h2>Log Files</h2>
  <p>thenftslot follows a standard procedure of using log files. These files log visitors when they
  ...
  <p>Like any other website, thenftslot uses cookies. These cookies are used to store information
  ...
  <p>For more general information on cookies, please read <a href="https://www.termsfeed.com/
blog/sample-cookies-policy-template/#What_Are_Cookies">the Cookies article on TermsFeed
      website</a>.</p>
  ...
  <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
    Beacons that are used in their respective advertisements and links that appear on thenftslot,
  ...
  <p>Note that thenftslot has no access to or control over these cookies that are used by thirdparty advertisers.</p>
  <h2>Third Party Privacy Policies</h2>
  <p>thenftslots Privacy Policy does not apply to other advertisers or websites. Thus, we are
  ...
  <p>Request that a business that collects a consumers personal data disclose the categories and
  ...
  <p>Request that a business delete any personal data about the consumer that a business has
    collected.</p>
  <p>Request that a business that sells a consumers personal data, not sell the consumers
    personal data.</p>
  ...
  <p>Another part of our priority is adding protection for children while using the internet. We
    ...
    activity.</p>
  <p className='mb-5'>thenftslot does not knowingly collect any Personal Identifiable Information from children under
